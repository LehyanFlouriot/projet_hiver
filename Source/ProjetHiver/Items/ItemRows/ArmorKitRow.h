...
#include "ArmorKitRow.generated.h"

class AReplicatedStaticMeshActor;
class USkeletalMesh;

USTRUCT(BlueprintType)
struct PROJETHIVER_API FArmorKitRow : public FTableRowBase
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, meta = (DisplayName = "Use Control Rig"))
	bool bUseControlRig = false;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, meta = (DisplayName = "Root Mesh"))
	USkeletalMesh* RootMesh = nullptr;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, meta = (DisplayName = "Armor Meshes"))
